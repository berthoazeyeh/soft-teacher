    ...
    return <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.content}>
            ...
            <View style={styles.headerContainer}>
                ...
                <View>
                    <Text style={{ ...Theme.fontStyle.montserrat.regular, fontSize: 14, color: theme.primaryText }}>Rendu le: <Text style={{ ...Theme.fontStyle.montserrat.semiBold }}> {assignmenSub && moment(assignmenSub?.submission_date).format("LLLL")}</Text></Text>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-evenly", paddingVertical: 5, alignItems: "center", gap: 10, }}>
                        <TouchableOpacity style={{ borderColor: theme.primary, borderWidth: 1, flex: 1, alignItems: "center", padding: 5, borderRadius: 5 }}>
                            <Text style={styles.textLab}>{"Note"}</Text>
                            <Text style={styles.textVal}>{assignmenSub?.marks} /20</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ borderColor: theme.primary, borderWidth: 1, flex: 1, alignItems: "center", padding: 5, borderRadius: 5 }}>
                            <Text style={styles.textLab}>{"Status"}</Text>
            ...
            <View >
                <Text style={styles.itemTitle}>{"Description du devoir Rendu"}</Text>
                <Divider />
            </View>
            ...
            <View >
                <Text style={styles.itemTitle}>{"Documents joints"}</Text>
                <Divider />
            </View>
            ...
            <View style={styles.modalView}>
                <ScrollView>
                    <View style={styles.contentContainer}>
                        ...
                        <Text style={styles.modalcontainerText}>{"En attribuant une note vous accepté le devoir"}</Text>
