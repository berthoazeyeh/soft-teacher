        ...
        <View style={styles.content}>
            <FlatList
                ...
                renderItem={({ item, index }) =>
                    <TouchableOpacity
                        onPress={() => {
                            navigation.navigate("StudentDetailsScreen", { classe: children, student: item })
                        }}
                        ...
                        <View style={{ width: 40, height: 40, borderRadius: 60, backgroundColor: theme.gray, padding: 2, borderColor: theme.gray4, borderWidth: 1 }}>
